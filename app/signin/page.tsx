    ...
    return (
        <main className="flex items-center bg-white py-6 sm:py-8 lg:py-12 h-screen">
            <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
                ...
                <form action={handleSignin} className="mx-auto max-w-lg rounded-lg border">
                    ...
                    <div className="flex items-center justify-center bg-gray-100 p-4">
                        <p className="text-center text-sm text-gray-500">Only administrators can login. <Link as="/" href="/" className="text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">Home</Link></p>
                    </div>
                </form>
            </div>
        </main>
