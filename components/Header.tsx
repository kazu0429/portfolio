...
const Header = ({ session }: { session: Session | null }) => {
    ...
    return (
        <div className='top-0 w-full'>
            <nav className='border-gray-200 px-4 lg:px-6 md:px-6 py-2.5 dark:border-black'>
                <div className='flex justify-between items-center mx-auto max-w-screen-xl'>
                    ...
                    <div className="flex items-center lg:order-2 md:order-2">
                        ...
                        <button onClick={() => setIsOpen(!isOpen)} type="button" data-collapse-toggle="mobile-menu-2" className="inline-flex items-center p-2 ml-1 text-sm rounded-lg lg:hidden md:hidden focus:outline-none focus:ring-2 focus:ring-gray-200 hover:bg-white" aria-controls="mobile-menu-2" aria-expanded="false">
                    ...
                    <div className={`absolute top-16 justify-between border w-1/3 z-50 right-0 mr-4 rounded-lg lg:items-center md:items-center lg:flex lg:w-auto md:flex md:w-auto lg:order-1 md:order-1 md:border-none lg:border-none m-2 shadow-black lg:relative md:relative lg:top-0 md:top-0 ${!isOpen && "hidden"}`} id="mobile-menu-2">
